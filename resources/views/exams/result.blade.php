<x-base title="Hasil Ujian" main-class="page">
  ...
  <h1 style="color: #7b0000; margin: 12px auto; text-align: center;">{{ $judul }}</h1>
  <div class="col-center" style="margin-top: 32px;">
    <div style="background-color: white; padding: 16px; border-radius: 8px;">
      <svg xmlns="http://www.w3.org/2000/svg" id="percentageCircle" width="150" height="150" viewBox="0 0 100 100">
